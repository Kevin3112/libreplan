...
public class CutyPrint {
    ...
    private static class CutyCaptParameters {
        ...
        private final ServletContext context = request.getSession().getServletContext();// &line[Web_Session]
        ...
        private static IServletRequestHandler executeOnOriginalContext(final IServletRequestHandler original) {
            final SecurityContext originalContext = SecurityContextHolder.getContext();  // &line[User]
