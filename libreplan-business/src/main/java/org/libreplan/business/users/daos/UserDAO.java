...
public class UserDAO extends GenericDAOHibernate<User, Long> implements IUserDAO {
    ...
    public User findByLoginName(String loginName) throws InstanceNotFoundException {
        ...
        User user = (User) getSession() // &line[Database_Session]
    ...
    public Number getRowCount() {
        return (Number) getSession().createCriteria(User.class).setProjection(Projections.rowCount()).uniqueResult(); // &line[Database_Session]
    }
}
